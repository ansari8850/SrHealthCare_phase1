class FiledResponseModel {
  ...
  factory FiledResponseModel.fromJson(Map<String, dynamic> json) =>
      FiledResponseModel(
        masterList: json["masterList"] == null
            ? []
            : List<FieldTypeModel>.from(
                json["masterList"]!.map((x) => FieldTypeModel.fromJson(x))),
        count: json["count"],
  ...
  Map<String, dynamic> toJson() => {
        "masterList": masterList == null
            ? []
            : List<dynamic>.from(masterList!.map((x) => x.toJson())),
        "count": count,
        "message": message,
      };
}
...
class FieldTypeModel {
  ...
  // Override `==` operator to compare objects by their fields
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is FieldTypeModel && other.name == name;
  }

  // Override `hashCode` to maintain consistency with `==`
  @override
