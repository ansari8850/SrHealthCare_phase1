...
HomePostListModel homePostListModelFromJson(String str) =>
    HomePostListModel.fromJson(json.decode(str));

String homePostListModelToJson(HomePostListModel data) =>
...
enum FieldName { AYURVEDA, HOMEOPATHYYY }

final fieldNameValues = EnumValues(
    {"Ayurveda": FieldName.AYURVEDA, "Homeopathyyy": FieldName.HOMEOPATHYYY});
...
enum Department { B_PHARMA, CARDIOLOGY, NURSING }
...
enum Email { AK_GMAIL_COM, ANURAGMAURYA_GMAIL_COM, SATYAM_IMG_GMAIL_COM }
...
enum LastName { KUSHWAHA, MAURYA, SINGH }
...
final loginTypeValues = EnumValues({"User": LoginType.USER});

enum Name { ANURAG, ARYAN, ATIF }

final nameValues =
    EnumValues({"Anurag": Name.ANURAG, "Aryan": Name.ARYAN, "Atif": Name.ATIF});
...
final passwordValues = EnumValues({
  "\u00242y\u002410\u00243s8nQHOnvhnd5k8jGLpCYunz4rQzIFkE5Lg7Uv3gUtqrQaiLve3W2":
      Password
          .THE_2_Y_103_S8_N_QH_ONVHND5_K8_J_G_LP_C_YUNZ4_R_QZ_I_FK_E5_LG7_UV3_G_UTQR_QAI_LVE3_W2,
  "\u00242y\u002410\u0024aSYabHNvS6Ci6KTxWdysB..HoL5XKA9c9ZK4USoEIXCAS5SwxZRYK":
      Password
          .THE_2_Y_10_A_S_YAB_H_NV_S6_CI6_K_TX_WDYS_B_HO_L5_XKA9_C9_ZK4_U_SO_EIXCAS5_SWX_ZRYK,
  "\u00242y\u002410\u0024ogzWWHLx4FNDGVaoOUjVfuAjtlQKXRHm50JbhGHQ4zZtVf.cGxu9O":
      Password
          .THE_2_Y_10_OGZ_WWH_LX4_FNDG_VAO_O_UJ_VFU_AJTL_QKXR_HM50_JBH_GHQ4_Z_ZT_VF_C_GXU9_O
});
...
final userTypeValues = EnumValues(
    {"Business": UserType.BUSINESS, "Individual": UserType.INDIVIDUAL});
